...
func TestAddGetDelete(t *testing.T) {
	...
	storage, err := store.Get(parcel.Number)
	require.NoError(t, err)
	assert.Equal(t, parcel, storage)
...
func TestSetAddress(t *testing.T) {
	...
	storage, err := store.Get(parcel.Number)
	require.NoError(t, err)
	assert.Equal(t, newAddress, storage.Address)
}
...
func TestSetStatus(t *testing.T) {
	...
	storage, err := store.Get(parcel.Number)
	require.NoError(t, err)
	assert.Equal(t, ParcelStatusSent, storage.Status)
}
